function thickcurve (id, close=true, color='white') {
...
function init() {
    ...
    loader.load( dir + 'top_plane.ply', function ( geometry ) {
    ...
    loader.load( dir + 'down_plane.ply', function ( geometry ) {
    ...
    loader.load( dir + 'mid_plane.ply', function ( geometry ) {
